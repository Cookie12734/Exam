...
public class GradeScoreDao extends Dao {
    public List<GradeScore> filter(School school, int entYear, String classNum, String subjectCd) throws Exception {
        ...
        try {
            ...
            String sql = "SELECT s.ENT_YEAR, s.CLASS_NUM, s.STUDENT_NO, s.STUDENT_NAME, sub.SUBJECT_NAME, t.POINT " +
                         ...
                         "WHERE s.SCHOOL_CD = ? AND s.ENT_YEAR = ? AND s.CLASS_NUM = ? AND sub.SUBJECT_CD = ?";
